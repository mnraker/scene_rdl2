...
private:
    RDL2_DSO_BUILTIN_API static AttributeKey<Bool> sAttrActive;
    RDL2_DSO_BUILTIN_API static AttributeKey<Int> sAttrResult;
    RDL2_DSO_BUILTIN_API static AttributeKey<String> sAttrOutputType;
    RDL2_DSO_BUILTIN_API static AttributeKey<int> sAttrStateVariable;
    RDL2_DSO_BUILTIN_API static AttributeKey<String> sAttrPrimitiveAttribute;
    RDL2_DSO_BUILTIN_API static AttributeKey<Int> sAttrPrimitiveAttributeType;
    RDL2_DSO_BUILTIN_API static AttributeKey<String> sAttrMaterialAov;
    RDL2_DSO_BUILTIN_API static AttributeKey<String> sAttrLpe;
    RDL2_DSO_BUILTIN_API static AttributeKey<String> sAttrVisibilityAov;
    RDL2_DSO_BUILTIN_API static AttributeKey<String> sAttrFileName;
    RDL2_DSO_BUILTIN_API static AttributeKey<String> sAttrFilePart;
    RDL2_DSO_BUILTIN_API static AttributeKey<Int> sAttrCompression;
    RDL2_DSO_BUILTIN_API static AttributeKey<Float> sAttrCompressionLevel;
    RDL2_DSO_BUILTIN_API static AttributeKey<String> sAttrChannelName;
    RDL2_DSO_BUILTIN_API static AttributeKey<Int> sAttrChannelSuffixMode;
    RDL2_DSO_BUILTIN_API static AttributeKey<Int> sAttrChannelFormat;
    RDL2_DSO_BUILTIN_API static AttributeKey<Int> sAttrMathFilter;
    RDL2_DSO_BUILTIN_API static AttributeKey<SceneObject *> sAttrExrHeaderAttributes;
    RDL2_DSO_BUILTIN_API static AttributeKey<Int> sAttrDenoiserInput;
    RDL2_DSO_BUILTIN_API static AttributeKey<Bool> sAttrDenoise;
    RDL2_DSO_BUILTIN_API static AttributeKey<String> sAttrCheckpointFileName;
    RDL2_DSO_BUILTIN_API static AttributeKey<String> sAttrCheckpointMultiVersionFileName;
    RDL2_DSO_BUILTIN_API static AttributeKey<String> sAttrResumeFileName;
    RDL2_DSO_BUILTIN_API static AttributeKey<Int> sAttrCryptomatteDepth;
    RDL2_DSO_BUILTIN_API static AttributeKey<Bool> sAttrCryptomatteOutputPositions;
    RDL2_DSO_BUILTIN_API static AttributeKey<Bool> sAttrCryptomatteOutputP0;
    RDL2_DSO_BUILTIN_API static AttributeKey<Bool> sAttrCryptomatteOutputNormals;
    RDL2_DSO_BUILTIN_API static AttributeKey<Bool> sAttrCryptomatteOutputBeauty;
    RDL2_DSO_BUILTIN_API static AttributeKey<Bool> sAttrCryptomatteOutputRefP;
    RDL2_DSO_BUILTIN_API static AttributeKey<Bool> sAttrCryptomatteOutputRefN;
    RDL2_DSO_BUILTIN_API static AttributeKey<Bool> sAttrCryptomatteOutputUV;
    RDL2_DSO_BUILTIN_API static AttributeKey<Bool> sAttrCryptomatteSupportResumeRender;
    RDL2_DSO_BUILTIN_API static AttributeKey<Bool> sAttrCryptomatteRecordReflected;
    RDL2_DSO_BUILTIN_API static AttributeKey<Bool> sAttrCryptomatteRecordRefracted;
    RDL2_DSO_BUILTIN_API static AttributeKey<SceneObject*> sCamera;
    RDL2_DSO_BUILTIN_API static AttributeKey<SceneObject*> sAttrDisplayFilter;
};
